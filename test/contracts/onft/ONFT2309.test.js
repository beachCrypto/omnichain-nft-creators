...
describe("ONFT721: ", function () {
    const chainId_A = 1
    const chainId_B = 2
    const name = "OmnichainNonFungibleToken using ERC2309"
    const symbol = "ONFT2309"
    const baseURIArgument = "ipfs://QmZPSjZKMjDUcqGuy6xS2EDQsJVFLyGHj3LUM2DkmCEfHo/"
    const startMintIDChain1 = 0
    const endMintIDChain1 = 10
    ...
    before(async function () {
        ...
        ONFT2309 = await ethers.getContractFactory("ONFT2309MOCK")
    })
    ...
    beforeEach(async function () {
        ...
        ONFT2309_A = await ONFT2309.deploy(
            name,
            symbol,
            minGasToStore,
    ...
    it("sendFrom() - your own tokens", async function () {
        console.log("Owner of token 0", await ONFT2309_A.ownerOf(0))
        console.log("Owner of token 1", await ONFT2309_A.ownerOf(1))
        console.log("Owner of token 10", await ONFT2309_A.ownerOf(10))
